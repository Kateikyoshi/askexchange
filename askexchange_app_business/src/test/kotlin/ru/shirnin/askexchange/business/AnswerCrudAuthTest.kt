...
class AnswerCrudAuthTest : FunSpec({
    ...
    test("create auth test") {
        runTest {
            ...
            val context = InnerAnswerContext(
                ...
                answerRequest = InnerAnswerStub.prepareResult {
            ...
            context.answerResponse.id.asString().isNotBlank() shouldBe true
            context.answerResponse.permissionsClient.shouldContainAll(
